...
==============================================================================*/   
 ...
 -----------------------------------------------------------------------------*/ 
    ...
    select marka_isim, calisan_sayisi, (select SUM(maas) from calisanlar
                                           where markalar.marka_isim=calisanlar.isyeri ) as toplam_maas  -- as ism vermek için/olmasa da çalışır kod.
    from markalar;                      -- aynı isim olursa başına tablo ismi koyarak sutun adını gireriz.
 ...
 -----------------------------------------------------------------------------*/
    ...
    select marka_isim, calisan_sayisi, (select round(AVG(maas)) from calisanlar
                                           where markalar.marka_isim=calisanlar.isyeri ) as ortalama_maas
    from markalar;    
 ...
 -----------------------------------------------------------------------------*/    
  ...
  select marka_isim, calisan_sayisi, (select MIN(maas) from calisanlar
                                           where markalar.marka_isim=calisanlar.isyeri ) as min_maas
    from markalar; 
 
  select marka_isim, calisan_sayisi, (select MAX(maas) from calisanlar
                                           where markalar.marka_isim=calisanlar.isyeri ) as max_maas
    from markalar; 
